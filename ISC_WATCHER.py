...
if(todays_date.month<10):
    month_str = f"0{todays_date.month}"
else:
    month_str = f"{todays_date.month}"

if(todays_date.day<10):
    day_str = f"0{todays_date.day}"
else:
    day_str = f"{todays_date.day}"

CURRENT_DAY_PATH = f'Orlando/{todays_date.year}/{month_str}/{day_str}'
print(f"CURRENT DAY {CURRENT_DAY_PATH}")
